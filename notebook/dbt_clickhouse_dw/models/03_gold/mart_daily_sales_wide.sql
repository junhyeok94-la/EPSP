...
* - 2026-06-22 [Antigravity] : Nullable 정렬 키 에러 해결을 위해 order_date Non-Nullable Date 변환 적용
=============================================================================
*/
...
select
    toDate(coalesce(order_purchase_timestamp, toDateTime('1970-01-01 00:00:00'))) as order_date,
